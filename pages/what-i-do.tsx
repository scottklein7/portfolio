...
function whatIDO() {
    return (
        <>
            <Head>
                <title>Scott Klein - Services I offer - Freelance Web Development </title>
                <meta name="description" content="Need web development, design, SEO, web analytics or more? Trust your needs to me - Scott Klein - a freelance web developer in the Shenandoah Valley Va & Northern VA" />
                <meta name="keywords" content="web development, SEO, web design, shenandoah valley VA, northern VA" />
            </Head>
