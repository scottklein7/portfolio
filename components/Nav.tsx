                    ...
                    <div className="flex items-center justify-between h-16">
                        <div className="flex items-center">
                            <div className="flex-shrink-0">
                                <h2 className="text-white"><span className="font-extrabold">Scott Klein</span> | <span className="font-light text-xs">Full-stack Developer</span></h2>
                            </div>
                    ...
                    {(ref) => (
                        <div className="md:hidden" id="mobile-menu">
                            <div ref={ref} className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                                ...
                                <Link href="/contact">
                                    <a className="block rounded-md text-base font-medium text-white hover:animate-pulse px-3 py-2 font-mono hover:text-blue-200">Contact</a>
                                </Link>
